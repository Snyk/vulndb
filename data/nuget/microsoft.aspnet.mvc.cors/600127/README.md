[`Microsoft.AspNet.Mvc.Cors`](https://www.nuget.org/packages/Microsoft.AspNet.Mvc.Cors) is the core runtime components of ASP.NET MVC.
...
## Remediation
Upgrade `Microsoft.AspNet.Mvc.Cors` to versions 1.0.6, 1.1.5 or higher.
