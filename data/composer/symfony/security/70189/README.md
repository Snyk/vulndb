# Overview
Affected versions of [`symfony/security`](https://packagist.org/packages/symfony/security) are vulnerable to Timing Attack.
...
## Remediation
Upgrade `symfony/security` to version 2.3.35, 2.6.12, 2.5.0, 2.7.7, 2.6.0 or higher.
