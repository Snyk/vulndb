[`Microsoft.AspNet.SignalR`](https://www.nuget.org/packages/Microsoft.AspNet.SignalR) is an Incredibly simple real-time web for .NET.
...
## Remediation
Upgrade `Microsoft.AspNet.SignalR` to version 1.1.4, 2.0.1 or higher.
