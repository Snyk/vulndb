## Overview
Affected versions of [`org.infinispan:infinispan-parent`](https://infinispan.org) are vulnerable to Deserialization of Untrusted Data.
...
## Remediation
Upgrade `org.infinispan:infinispan-parent` to version 9.1.0.Final or higher.

## References
- [Bugzilla Redhat](https://bugzilla.redhat.com/show_bug.cgi?id&#x3D;1300443)
- [GitHub PR](https://github.com/infinispan/infinispan/pull/5116)
- [GitHub Commit](https://github.com/infinispan/infinispan/commit/f2989a9b7b5ef2d3be690250d9d1bc7b2fa045d7)
