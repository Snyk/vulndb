# Overview
Affected versions of [`symfony/security-csrf`](https://packagist.org/packages/symfony/security-csrf) are vulnerable to Cross-site Request Forgery (CSRF).
...
## Remediation
Upgrade `symfony/security-csrf` to versions 2.7.38, 2.8.31, 3.1.0, 3.2.0, 3.2.14, <3.3.13 higher.
