# Overview
Affected versions of [`symfony/intl`](https://packagist.org/packages/symfony/intl) are vulnerable to Directory Traversal.
...
## Remediation
Upgrade `symfony/intl` to versions 2.7.38, 2.8.31, 3.1.0, 3.2.0, 3.2.14, <3.3.13 higher.
