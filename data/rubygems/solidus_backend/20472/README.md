## Overview
[`solidus_backend`](https://rubygems.org/gems/solidus_backend) is Admin interface for the Solidus e-commerce framework.
...
## Remediation
Upgrade `solidus_backend` to version 1.1.0.pre2 or higher.
