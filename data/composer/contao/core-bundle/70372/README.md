## Overview
Affected versions of [`contao/core-bundle`](https://packagist.org/packages/contao/core-bundle) are vulnerable to SQL Injection
...
## Remediation
Upgrade `contao/core-bundle` to versions 3.5.30, 4.4.8 or higher.
