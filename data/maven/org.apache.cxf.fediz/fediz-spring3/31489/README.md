## Overview
[`org.apache.cxf.fediz:fediz-spring3`](https://cxf.apache.org/) is an open source services framework.
...
## Remediation
Upgrade `org.apache.cxf.fediz:fediz-spring3` to version 1.2.4, 1.3.2, 1.4.0 or higher.
