[`Microsoft.AspNet.SignalR.Core`](https://www.nuget.org/packages/Microsoft.AspNet.SignalR.Core) is the Core server components for ASP.NET SignalR.
...
## Remediation
Upgrade `Microsoft.AspNet.SignalR.Core` to version 1.1.4, 2.0.1 or higher.
