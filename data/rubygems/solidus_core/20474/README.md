## Overview
[`solidus_core`](https://rubygems.org/gems/solidus_core) is Essential models, mailers, and classes for the Solidus e-commerce project.
...
## Remediation
Upgrade `solidus_core` to version 1.1.0.pre2 or higher.
