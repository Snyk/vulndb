# Overview
Affected versions of [`zendframework/zend-session`](https://packagist.org/packages/zendframework/zend-session) are vulnerable to Insufficient Session Validation.
...
## Remediation
Upgrade `zendframework/zend-session` to version 2.3.4, 2.2.9 or higher.
