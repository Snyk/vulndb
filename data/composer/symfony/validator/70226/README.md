# Overview
Affected versions of [`symfony/validator`](https://packagist.org/packages/symfony/validator) are vulnerable to Loss of Information.
...
## Remediation
Upgrade `symfony/validator` to version 2.3.3, 2.1.12, 2.2.5, 2.0.24 or higher.
