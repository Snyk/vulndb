## Overview
Affected versions of [`org.springframework.amqp:spring-amqp`](https://amqp.springframework.org) are vulnerable to Deserialization of Untrusted Data. An attacker may send a specially crafted `org.springframework.amqp.core.Message`, which will be unsafely deserialized when converted into a string.
...
## Remediation
Upgrade `org.springframework.amqp:spring-amqp` to version 1.5.7, 1.6.11, 1.7.4 or higher.
...
- [Pivotal Security Advisory](https://pivotal.io/security/cve-2017-8045)
- [Jira Issue](https://jira.spring.io/browse/AMQP-766)
