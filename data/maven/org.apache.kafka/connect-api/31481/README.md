## Overview
[`org.apache.kafka:connect-api`](https://kafka.apache.org) is a distributed streaming platform.

Affected versions of the package are vulnerable to Deserialization of Untrusted Data via `FileOffsetBackingStore`.

*Note:* This issue is only exploitable for some JDK7.x versions.
...
## Remediation
Upgrade `org.apache.kafka:connect-api` to versions 0.9.0.1, 0.10.0.1, 0.10.1.1, 0.10.2.1, 0.11.0.0 or higher.

## References
- [Openwall](http://www.openwall.com/lists/oss-security/2017/07/19/1)
- [Github PR](https://github.com/apache/kafka/pull/3563)
- [Github Commit](https://github.com/apache/kafka/pull/3563/commits/fcd4d5f069aa084a6bab9dea4f81de0d63bcfbe8)
