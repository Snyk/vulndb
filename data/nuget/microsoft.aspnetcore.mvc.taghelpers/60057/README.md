[`Microsoft.AspNetCore.Mvc.TagHelpers`](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.TagHelpers) contains tag helpers for anchor tags, HTML input elements, caching, scripts, links (for CSS), and more.
...
## Remediation
Upgrade `Microsoft.AspNetCore.Mvc.TagHelpers` to version 1.0.4, 1.1.3 or higher.
