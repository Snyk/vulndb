# Overview
Affected versions of [`symfony/routing`](https://packagist.org/packages/symfony/routing) are vulnerable to XML External Entity (XXE) Injection.
...
## Remediation
Upgrade `symfony/routing` to version 2.0.17 or higher.
