## Overview
[`org.apache.james:james-server`](https://james.apache.org) is the Java Apache Mail Enterprise Server.
...
## Remediation
Upgrade `org.apache.james:james-server` to version 3.0.1 or higher.

## References
- [Apache Mailing List](https://www.mail-archive.com/server-user@james.apache.org/msg15633.html)
- [NVD](https://nvd.nist.gov/vuln/detail/CVE-2017-12628)
