## Overview
[`backports.ssl_match_hostname`](https://pypi.python.org/pypi/backports.ssl_match_hostname) is a The ssl.match_hostname() function from Python 3.5
...
## References
- [Python Issue](http://bugs.python.org/issue17980)
