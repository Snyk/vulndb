# Overview
Affected versions of [`symfony/translation`](https://packagist.org/packages/symfony/translation) are vulnerable to XML External Entity (XXE) Injection.
...
## Remediation
Upgrade `symfony/translation` to version 2.0.17 or higher.
