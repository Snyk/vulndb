# Overview
Affected versions of [`symfony/routing`](https://packagist.org/packages/symfony/routing) are vulnerable to Path Disclosure.
...
## Remediation
Upgrade `symfony/routing` to version 2.0.19 or higher.
