[`Microsoft.AspNet.SignalR.Core.zh-Hans`](https://www.nuget.org/packages/Microsoft.AspNet.SignalR.Core.zh-Hans) contains Simplified Chinese satellite assemblies for ASP.NET SignalR Core.
...
## Remediation
Upgrade `Microsoft.AspNet.SignalR.Core.zh-Hans` to version 1.1.4, 2.0.1 or higher.

## References
- [NVD](https://nvd.nist.gov/vuln/detail/2013-5042)
- [Microsoft Security Advisory](http://technet.microsoft.com/security/bulletin/MS13-103)
