## Overview
[`com.typesafe.akka:akka-http-core_2.11`](https://akka.typesafe.com) modules implement a full server and client-side HTTP stack on top of akka-actor and akka-stream.
