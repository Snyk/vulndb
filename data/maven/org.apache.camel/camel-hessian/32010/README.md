## Overview
[`org.apache.camel:camel-http`](https://camel.apache.org/) is a versatile open-source integration framework based on known Enterprise Integration Patterns.
...
## References
- [NVD](https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2017-12633)
- [Apache Camel Security Advisory](http://camel.apache.org/security-advisories.data/CVE-2017-12633.txt.asc)
- [Apache Camel Jira Issue](https://issues.apache.org/jira/browse/CAMEL-11923)
