## Overview
Affected versions of [`org.owasp.antisamy:antisamy`](https://antisamy.owasp.org) are vulnerable to Cross-site Scripting (XSS).
...
## References
- [GitHub PR](https://nvd.nist.gov/vuln/detail/CVE-2017-14735)
