## Overview
Affected versions of [`html5lib`](https://pypi.python.org/pypi/html5lib) are vulnerable to Cross-site Scripting (XSS) attacks.
...
## References
- [NVD](https://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2016-9909)
