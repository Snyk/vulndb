## Overview
[`org.apache.camel:camel-jacksonxml`](http://camel.apache.org/) is a powerful open source integration framework based on known Enterprise Integration Patterns with powerful bean integration.
...
## References
- [Java Unmarshaller Security by Moritz Bechler](https://github.com/mbechler/marshalsec/blob/master/marshalsec.pdf)
- [Apache Camel Security Advisory](http://camel.apache.org/security-advisories.data/CVE-2016-8749.txt.asc)
- [NVD](https://nvd.nist.gov/vuln/detail/CVE-2016-8749)
