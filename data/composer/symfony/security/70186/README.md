# Overview
Affected versions of [`symfony/security`](https://packagist.org/packages/symfony/security) are vulnerable to Path Disclosure.
...
## Remediation
Upgrade `symfony/security` to version 2.0.19 or higher.
