# Overview
Affected versions of [`symfony/http-foundation`](https://packagist.org/packages/symfony/http-foundation) are vulnerable to Path Disclosure.
...
## Remediation
Upgrade `symfony/http-foundation` to version 2.0.19 or higher.
