[`Microsoft.AspNetCore.Mvc.Formatters.Xml`](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.Formatters.Xml) contains formatters for XML input and output using DataContractSerializer and XmlSerializer.
...
## Remediation
Upgrade `Microsoft.AspNetCore.Mvc.Formatters.Xml` to version 1.0.4, 1.1.3 or higher.
