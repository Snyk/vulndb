# Overview
Affected versions of [`symfony/validator`](https://packagist.org/packages/symfony/validator) are vulnerable to XML External Entity (XXE) Injection.
...
## Remediation
Upgrade `symfony/validator` to version 2.0.17 or higher.
