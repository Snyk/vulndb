# Overview
Affected versions of [`symfony/security`](https://packagist.org/packages/symfony/security) are vulnerable to Denial of Service (DoS).
...
## Remediation
Upgrade `symfony/security` to version 2.3.6, 2.1.13, 2.2.9, 2.0.25 or higher.
